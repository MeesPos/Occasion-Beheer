              ...
              <span class="group flex items-center justify-between px-4 py-4 hover:bg-gray-50 sm:px-6">
                ...
                <span id="item-dropdown-toggle-mob">
                    <span class="relative flex justify-end items-center">
                      ...
                      <div id="item-dropdown-mob" style="opacity: 0;" class="mx-3 origin-top-right absolute right-7 top-0 w-48 mt-1 rounded-md shadow-lg z-10 bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-200" role="menu" aria-orientation="vertical" aria-labelledby="project-options-menu-0">
            ...
            <table class="min-w-full">
              ...
              <tbody class="bg-white divide-y divide-gray-100">
                <tr>
                  ...
                  <td class="pr-6" id="item-dropdown-toggle">
                    <div class="relative flex justify-end items-center">
                      ...
                      <div id="item-dropdown" style="opacity: 0;" class="mx-3 origin-top-right absolute right-7 top-0 w-48 mt-1 rounded-md shadow-lg z-10 bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-200" role="menu" aria-orientation="vertical" aria-labelledby="project-options-menu-0">
                        <div class="py-1" role="none">
                          <a href="#" class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                            <svg class="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                              <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
