                    ...
                    <fieldset class="mt-6 sm:col-span-3">
                        ...
                        <div class="grid grid-cols-2">
                            <div class="flex items-center mt-2">
                                <input id="soort" name="soort" type="radio" value="Busje" checked
                            ...
                            <div class="flex items-center mt-2">
                                <input id="soort" name="soort" type="radio" value="SUV"
                                    class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                <label for="soort" class="ml-3 block text-sm font-medium text-gray-700">
                                    SUV
                                </label>
                            ...
                            <div class="flex items-center mt-2">
                                <input id="soort" name="soort" type="radio" value="Persoonsauto"
                                    class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                <label for="soort" class="ml-3 block text-sm font-medium text-gray-700">
                                    Persoonsauto
                                </label>
                            ...
                            <div class="flex items-center mt-2">
                                <input id="soort" name="soort" type="radio" value="Cabrio"
                                    class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                <label for="soort" class="ml-3 block text-sm font-medium text-gray-700">
                                    Cabrio
                                </label>
                            ...
                            <div
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <span class="text-indigo-600 hover:text-indigo-500" id="upload-text">Klik hier om
